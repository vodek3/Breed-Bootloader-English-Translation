...
In Unicode, each Chinese character in UTF-8 encoding takes up 3 bits (4 bits for rare characters; I don't remember that’s I've seen 4-bit characters in Breed).  
